...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        for (Customer customer : customerList) {
            System.out.println(customer.getFirstName() + " " + customer.getLastName() + " " + customer.getHomeAddress().getShortAddress() + " " + customer.getWorkAddress().getShortAddress());
        }

        System.out.println(customerList);

        customerList.forEach(item -> System.out.println(item.getFirstName() + " " + item.getLastName() + " " +item.getHomeAddress().getShortAddress()));
    }
}
